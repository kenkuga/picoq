...
class T5_from_tokenizer:
    """ Custom SimpleT5 class """

    def __init__(self, model_name, t5_tokenizer_dir) -> None:
        ...
        """
        self.model_name = model_name  # t5-small, t5-base, t5-large
        self.tokenizer = AutoTokenizer.from_pretrained(t5_tokenizer_dir)
